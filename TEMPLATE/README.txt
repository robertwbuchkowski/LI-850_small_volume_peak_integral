...
Identification: The identification of the sample or standard. Standards injected in the same bout should have the SAME name (e.g., S1 for the first set, S2 for the second set).
